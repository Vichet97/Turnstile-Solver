...
class TurnstileSolver:
    ...
    def _solve_with_seleniumbase(self, url: str, sitekey: str, action: str = None, cdata: str = None):
    ...
    def solve(self, url: str, sitekey: str, action: str = None, cdata: str = None):
        ...
        if self.browser_type == "seleniumbase":
            return self._solve_with_seleniumbase(url, sitekey, action, cdata)
...
def get_turnstile_token(url: str, sitekey: str, action: str = None, cdata: str = None, debug: bool = False, headless: bool = False, useragent: str = None, browser_type: str = "seleniumbase"):
